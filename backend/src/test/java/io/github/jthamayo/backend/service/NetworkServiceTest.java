...
public class NetworkServiceTest {
	...
	@BeforeEach
	void setUp() {
	    user1 = new User(1L, "testUser1", "lastname", "username", "email", "phoneNumber", false);
	    user2 = new User(2L, "testUser2", "lastname", "username", "email", "phoneNumber", false);
	...
	void testCreateNetwork() {
	    ...
	    when(requestRepository.findAcceptedRequestBetweenUsers(user1.getId(), user2.getId()))
